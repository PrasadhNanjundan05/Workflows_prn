...
object_parameters                       = json.loads(context['params_string']) 
object_parameters['VNI_POOLSerialized'] = object_parameters['VNI_POOL']

vnis_serialized_serialized              = json.dumps( object_parameters['VNI_POOL'][object_id]['vnisInUse'])
object_parameters['VNI_POOLSerialized'][object_id]['vnisInUse_Serialized'] = vnis_serialized_serialized
del object_parameters['VNI_POOLSerialized'][object_id]['vnisInUse']
del object_parameters['VNI_POOL']

object_parameters['VNI_POOLSerialized']["90d11a7c-c46e-41ed-95b9-3a32463ce044"] = object_parameters['VNI_POOLSerialized'][object_id]
object_parameters['VNI_POOLSerialized']["90d11a7c-c46e-41ed-95b9-3a32463ce055"] = object_parameters['VNI_POOLSerialized'][object_id]
object_parameters['VNI_POOLSerialized']["90d11a7c-c46e-41ed-95b9-3a32463ce066"] = object_parameters['VNI_POOLSerialized'][object_id]
